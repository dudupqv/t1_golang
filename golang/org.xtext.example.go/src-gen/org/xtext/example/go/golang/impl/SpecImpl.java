 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.example.go.golang.impl.SpecImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.example.go.golang.impl.SpecImpl#getExpressions <em>Expressions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SpecImpl extends MinimalEObjectImpl.Container implements Spec
{
  ...
  {
    return GolangPackage.Literals.SPEC;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, GolangPackage.SPEC__NAME, oldName, name));
  }
  ...
  public EList<String> getExpressions()
  {
    if (expressions == null)
    {
      expressions = new EDataTypeEList<String>(String.class, this, GolangPackage.SPEC__EXPRESSIONS);
    }
    return expressions;
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case GolangPackage.SPEC__NAME:
        return getName();
      case GolangPackage.SPEC__EXPRESSIONS:
